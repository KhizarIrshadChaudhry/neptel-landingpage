...
export default function UseCases() {
  ...
  return (
    ...
    >
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-12">Use Cases</h2>
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {cases.map(([title, icon, desc]) => (
          <div key={title} className="bg-[#141A1F] p-6 rounded-2xl text-center hover:shadow-lg transition">
            ...
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold mb-2">{title}</h3>
